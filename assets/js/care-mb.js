...
;// CONCATENATED MODULE: ./src/assets/scripts/components/fcare/care-mb.js
/* provided dependency */ var care_mb_$ = __webpack_require__(19755);
...
var slidesServiceMenu = care_mb_$('.js-service-menu .item').length;
if (slidesServiceMenu <= 4) {
  care_mb_$('.wrap-list-service-price').addClass('no-swiper-btn');
}

var swiper5 = new core('.mySwiper8', {
  slidesPerView: 1,
  slidesPerGroup: 1,
  spaceBetween: 24,
...
// open gallery
care_mb_$('.js-open-gallery').on("click", function (e) {
  care_mb_$(".lg-gallery")
    .addClass("lg-show lg-show-in")
    .css("pointer-events", "unset");
  care_mb_$(".js-gallery:nth-child(3)").trigger("click");
});
