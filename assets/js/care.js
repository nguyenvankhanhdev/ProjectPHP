...
;// CONCATENATED MODULE: ./src/assets/scripts/components/fcare/care.js
/* provided dependency */ var care_$ = __webpack_require__(19755);


var serviceMenu = new core('.js-service-menu .swiper', {
  slidesPerView: 'auto',
  spaceBetween: 0,
  navigation: {
...
var slidesServiceMenu = care_$('.js-service-menu .item').length;
if (slidesServiceMenu <= 4) {
  care_$('.wrap-list-service-price').addClass('no-swiper-btn');
}

var swiper5 = new core('.mySwiper5', {
  slidesPerView: 1,
  slidesPerGroup: 1,
  spaceBetween: 24,
...
var swiper6 = new core('.mySwiper6', {
  slidesPerView: 4,
  slidesPerGroup: 1,
  spaceBetween: 24,
  // allowTouchMove: false,
...
var swiper7 = new core(".mySwiper7", {
  spaceBetween: 10,
  navigation: {
    nextEl: ".swiper-button-next",
    prevEl: ".swiper-button-prev"
...
// open gallery
care_$('.js-open-gallery').on("click", function (e) {
  care_$(".lg-gallery")
    .addClass("lg-show lg-show-in")
    .css("pointer-events", "unset");
  care_$(".js-gallery:nth-child(3)").trigger("click");
});

care_$('.chat-modal.open').removeClass('.modal-prevent-scroll');
