...
;// CONCATENATED MODULE: ./src/assets/scripts/components/b2s/b2s-mb.js
/* provided dependency */ var b2s_mb_$ = __webpack_require__(19755);
...
let scrollItems = '',
  lastId,
  topMenu = b2s_mb_$(".section__nav"),
  topMenuHeight = topMenu.outerHeight(),
  menuItems = '';
b2s_mb_$(document).on("click", "[to-scroll]", function (e) {
  e.preventDefault();
  var link = b2s_mb_$(this).attr("to-scroll");
  if (b2s_mb_$(link).length > 0) {
    var posi = b2s_mb_$(link).offset().top - 49;
    b2s_mb_$("body,html").animate(
      {
        scrollTop: posi,
      },
      600
...
scrollItems = menuItems.map(function () {
  var item = b2s_mb_$(b2s_mb_$(this).attr("toscroll"));
  if (item.length) { return item; }
});


// Bind to scroll
b2s_mb_$(window).scroll(function () {
  // Get container scroll position
  var fromTop = b2s_mb_$(this).scrollTop() + topMenuHeight;

  // Get id of current scroll item
  var cur = scrollItems.map(function () {
    if (b2s_mb_$(this).offset().top < fromTop)
      return this;
  });
...
function navScrollToSection(menuItems) {
  ...
  menuItems.on('click', function (e) {
    e.preventDefault();
    var href = b2s_mb_$(this).attr("toscroll"),
      offsetTop = href === "#" ? 0 : b2s_mb_$(href).offset().top - topMenuHeight + 1;
    b2s_mb_$('html, body').stop().animate({
      scrollTop: offsetTop
    }, 1000);
...
b2s_mb_$(".modal-animation .gift").click(function () {
  b2s_mb_$(this).addClass("active");
  setTimeout(function () {
    b2s_mb_$(".modal-animation").click(function () {
      b2s_mb_$(this).removeClass("open").bind(".modal-animation");

    });
  }, 5000);
  setTimeout(function () {
    b2s_mb_$(".modal-animation").removeClass("open");
  }, 6000);

  b2s_mb_$(".modal").mouseup(function (e) {
    var container = b2s_mb_$(".modal-wrapper");
    // if the target of the click isn't the container nor a descendant of the container
    if (!container.is(e.target) && container.has(e.target).length === 0) {
      b2s_mb_$(".modal").removeClass("open");
      b2s_mb_$(".modal").removeClass("modal--is-visible");
      b2s_mb_$("html").removeClass("no-scroll");
    }
  });
});
})();
