...
;// CONCATENATED MODULE: ./src/assets/scripts/components/detail/detail-mb.js
/* provided dependency */ var detail_mb_$ = __webpack_require__(19755);
...
document.addEventListener('DOMContentLoaded', function (event) {
    var countSlide = detail_mb_$(".slider-gallery__main .swiper-slide");
    var offer = detail_mb_$('.badge-count-pagination span');
    var detailHeaderGalleryMain = new core('.gallery-main', {
        ...
        on: {
            init: function() {
                offer.text(`Hình ${this.activeIndex + 1}/${countSlide.length}`);
            },
    ...
    const lgTemp = lightgallery_es5(document.querySelector('#animated-thumbnails-gallery'), {
	...
	document.querySelectorAll(".footer .swiper-slide").forEach(item => {
        item.addEventListener("click", () => {
            lgTemp && lgTemp.destroy(true);
            lgTemp.openGallery();
        })
    })
	
	// add gallery when click to image 
    detail_mb_$(".swiper.gallery-main").click(function (e) {
        var senderElement = e.target;
        // Check if sender is the <div> element e.g.
        if (detail_mb_$(e.target).hasClass("swiper-button-next")) {
	...
	const subPlugin = lightgallery_es5(document.querySelector('.js-gallery'),{
        plugins: [lg_zoom_es5, lg_thumbnail_es5, lg_fullscreen_es5, lg_autoplay_es5],
		speed: 500,
		licenseKey: 'your_license_key',
		showZoomInOutIcons: true,
    ...
    // (function () {
        // lightGallery(document.querySelector('.js-gallery'), {
            // plugins: [lgZoom, lgThumbnail, lgFullscreen, lgAutoplay],
            // licenseKey: 'your-license-key',
            // addClass: `lg-detail-header`,
            // thumbnail: true,
            // speed: 500,
            // thumbWidth: 96,
            // thumbHeight: '64px',
    ...
    //     e.preventDefault();
    //     $('.js-gallery .swiper-slide').trigger('click');
    // });
    ...
    function handleProperties() {
        var container = detail_mb_$('.js-modal-properties');
        ...
        container
            .scroll(function () {
                var scrollDistance = detail_mb_$(this).scrollTop();
                // Assign active class to nav links while scolling\
                block.each(function (i) {
                    if (detail_mb_$(this).position().top <= scrollDistance + 50) {
                        nav.find('.item').removeClass('active');
                        // nav.find('.item').eq(i).addClass('active').focus();
                        propertiesMenu.slideTo(i, 500);
                    }
                });
                // show navigation
                if (navPosition - (90 + navHeight) <= scrollDistance) {
                    //100 is margin
                    nav.addClass('active');
                } else {
        ...
        function goToByScroll(id) {
            var scrollTo = detail_mb_$(id);
            container.animate({
                scrollTop: scrollTo.offset().top -
                    container.offset().top +
                    container.scrollTop() -
                    (nav.outerHeight() + headingHeight),
            },
                800
            );
        }
        //Bắt sự kiện click và gọi hàm scroll
        detail_mb_$('.properties__menu .swiper-slide').click(function (e) {
            e.preventDefault();
            var index = detail_mb_$('.properties__menu .swiper-slide').index(detail_mb_$(this));
            propertiesMenu.slideTo(index, 500);
            propertiesMenu.update();
            var data = detail_mb_$(this).attr('data-ref');
            goToByScroll(data);
        });
    }
    handleProperties();

    //   light gallery for comment
    function containerLg() {
        var lgWrap = document.querySelector('.lg-container.lg-show #lg-outer-1');
