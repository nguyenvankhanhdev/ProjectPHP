...
/* harmony default export */ const lightgallery_es5 = ((/* unused pure expression or super */ null && (lightGallery)));
...
;// CONCATENATED MODULE: ./src/assets/scripts/components/slider.js
/* provided dependency */ var slider_$ = __webpack_require__(19755);
...
// open gallery
slider_$('.js-open-gallery').on("click", function (e) {
  slider_$(".lg-gallery")
    .addClass("lg-show lg-show-in")
    .css("pointer-events", "unset");
  slider_$(".js-gallery:nth-child(3)").trigger("click");
});
