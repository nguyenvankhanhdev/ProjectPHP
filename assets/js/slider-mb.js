...
;// CONCATENATED MODULE: ./src/assets/scripts/components/slider-mb.js
/* provided dependency */ var slider_mb_$ = __webpack_require__(19755);
...
slider_mb_$('.js-open-gallery').on("click", function (e) {
  slider_mb_$(".lg-gallery")
    .addClass("lg-show lg-show-in")
    .css("pointer-events", "unset");
  slider_mb_$(".js-gallery:nth-child(2)").trigger("click");
});
